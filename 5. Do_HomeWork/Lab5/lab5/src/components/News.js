...
function News() {
    return (
        <>
            <h1 className='text-danger'>News Category</h1>
            <div style={{ marginRight: '0' }} className='row'>
                {newLists.map(newsItem => (
                    <div key={newsItem.id} className='col-md-4 col-lg-3 col-sm-6 mb-4'>
                        <div className="card">
                            <img src={newsItem.images} className="card-img-top" alt={newsItem.title} />
